...
M.DIAG = {
    ...
    BROKEN_ARM = {
        name             = "Broken Arm",
        category         = "standard",
        description      = "Broken arm. Splint the fracture directly — bones are already visible.",
        initialTemp      = 98.6,
        tempRising       = false,
        initialPulse     = "STRONG",
    ...
    BROKEN_LEG = {
        name             = "Broken Leg",
        category         = "standard",
        description      = "Broken leg with shattered fragments. Bones already visible — Anesthetic, Scalpel, Pins, Splint.",
        initialTemp      = 98.6,
        tempRising       = false,
        initialPulse     = "STEADY",
        initialBleeding  = "SLIGHT",
    ...
    LIVER_INFECTION = {
        ...
        category         = "standard",
        description      = "Infected liver. Ultrasound to confirm, Lab Kit, Antibiotics to reduce fever, two incisions, Fix It.",
        initialTemp      = 104.6,
        tempRising       = true,
        initialPulse     = "STEADY",
        initialBleeding  = "NONE",
        initialSiteClean = "SLIGHTLY_DIRTY",
        brokenBones      = 0,
        shatteredBones   = 0,
        needsLabKit      = true,
        needsUltrasound  = true,
        ...
        requiredScalpels = 2,
        heartStopChance  = 0,
        headline         = "Patient has a liver infection.",
        scalpelHeadline  = "You've accessed the liver.",
        scalpelContextMsg = "You've accessed the liver.",
        fixItHeadline    = "You treated the source of the infection!",
    },
    ...
    APPENDICITIS = {
        name             = "Appendicitis",
        category         = "standard",
        description      = "Severe inflammation. Ultrasound to confirm, Lab Kit, reduce fever, then operate.",
        initialTemp      = 103.0,
        tempRising       = true,
        initialPulse     = "STEADY",
        initialBleeding  = "NONE",
    ...
    BROKEN_EVERYTHING = {
        ...
        category         = "standard",
        description      = "Run over by a truck. Ultrasound first, Lab Kit, Antibiotics, Anesthetic, Scalpel x2, Pins all shattered bones, Fix It, Splint all broken, Stitch up.",
        initialTemp      = 100.6,
        tempRising       = true,
        initialPulse     = "STRONG",
        initialBleeding  = "SLIGHT",
        initialSiteClean = "SLIGHTLY_DIRTY",
        initialVisibility = "SLIGHTLY_HARD",
        brokenBones      = 0,
        shatteredBones   = 4,
        needsLabKit      = true,
        needsUltrasound  = true,
        ...
        headline         = "Patient was run over by a truck.",
        scalpelHeadline  = "You've found gravel in the knees.",
        scalpelContextMsg = "You've found gravel in the knees.",
        fixItHeadline    = "You removed the gravel!",
    },
    ...
    TORN_PUNCHING_MUSCLE = {
        ...
        category          = "malady",
        description       = "Punched too many blocks. Sponge to clear visibility, Lab Kit, Ultrasound to reveal, Anesthetic, Scalpel, Fix It, Stitches.",
        initialTemp       = 98.6,
        tempRising        = false,
        initialPulse      = "STRONG",
        initialBleeding   = "NONE",
        ...
        requiredScalpels  = 1,
        heartStopChance   = 0,
        headline          = "Patient has a torn punching muscle.",
        scalpelHeadline   = "You've made a neat incision.",
        scalpelContextMsg = "You've made a neat incision.",
        fixItHeadline     = "You fixed the issue!",
    },

    GEM_CUTS = {
        name             = "Gem Cuts",
        category         = "malady",
        description      = "Wounds from picking up gems. Lab Kit, Ultrasound to diagnose, Anesthetic, two Scalpel incisions, Fix It, Stitches.",
        initialTemp      = 98.6,
        tempRising       = false,
        initialPulse     = "STRONG",
        initialBleeding  = "SLIGHT",
        ...
        requiredScalpels = 2,
        heartStopChance  = 0,
        headline          = "Patient is bleeding from multiple gem-induced cuts.",
        scalpelHeadline   = "You've made a neat incision.",
        scalpelContextMsg = "You've made a neat incision.",
        fixItHeadline     = "You've stitched the gem cuts closed and stopped the bleeding.",
    },

    BROKEN_HEART_MALADY = {
        name             = "Broken Heart",
        category         = "malady",
        description      = "Too many surgeries broke your own heart. Lab Kit, Ultrasound to diagnose (2 shattered bones), VERY HIGH heart stop chance! Keep Defibrillator ready.",
        initialTemp      = 107.6,
        tempRising       = true,
        initialPulse     = "STRONG",
        initialBleeding  = "NONE",
        ...
        headline          = "Patient suffered from a Broken Heart.",
        scalpelHeadline   = "You've revealed the heart.",
        scalpelContextMsg = "You've revealed the heart.",
        fixItHeadline     = "You fixed the issue!",
    },
    ...
    GRUMBLETEETH = {
        name              = "Grumbleteeth",
        category          = "malady",
        description       = "Chatted too much. High fever, weak pulse, hard to see. Lab Kit, Ultrasound, sedate, Scalpel, Fix It. Heart may stop — keep Defibrillator ready.",
        initialTemp       = 104.6,
        tempRising        = false,
        initialPulse      = "WEAK",
        initialBleeding   = "NONE",
        ...
        needsFixIt        = true,
        requiredScalpels  = 1,
        heartStopChance   = 0.08,
        headline          = "Patient's teeth are chattering They sound angry.",
        scalpelHeadline   = "You removed grumbleteeth",
        scalpelContextMsg = "You removed grumbleteeth",
        fixItHeadline     = "You fixed the issue!",
    },
    ...
    CHICKEN_FEET = {
        name              = "Chicken Feet",
        category          = "malady",
        description       = "Walked too much and grew chicken feet. Sponge to see, fever rising. Lab Kit, Ultrasound, sedate, 2 Scalpels, Fix It. 2 shattered bones.",
        initialTemp       = 98.6,
        tempRising        = true,
        initialPulse      = "STRONG",
        initialBleeding   = "NONE",
        ...
        requiredScalpels  = 2,
        heartStopChance   = 0,
        headline          = "Patient feet have turned into chicken toes..",
        scalpelHeadline   = "You've insvestigated the feet.",
        scalpelContextMsg = "You've made a neat incision.",
        fixItHeadline     = "You fixed the issue!",
    },
    ...
    CHAOS_INFECTION = {
        ...
        category          = "vile_vial",
        description       = "Pure chaos. Site starts Unsanitary, IMPOSSIBLE visibility, RAPID bleeding, high fever. Sponge→Lab Kit→Ultrasound, sedate, 3 Scalpels, Fix It. Random chaos events each turn.",
        initialTemp       = 107.6,
        tempRising        = true,
        initialPulse      = "STEADY",
        initialBleeding   = "RAPID",
        initialVisibility = "IMPOSSIBLE",
        initialSiteClean  = "UNSANITARY",
        brokenBones       = 1,
        shatteredBones    = 1,
        needsLabKit       = true,
        needsUltrasound   = true,
        needsFixIt        = true,
        requiredScalpels  = 3,
        heartStopChance   = 0,   -- chaos special event handles heart stops randomly
        specialEvent      = "chaos",
        headline          = "Patient suffers from a Chaos Infection.",
        scalpelHeadline   = "You've exposed a central artery.",
        scalpelContextMsg = "You've made a neat incision.",
        fixItHeadline     = "You've drawn the corrupted blood out of the patient and severed their connection to chaos.",
    },

    LUPUS = {
        name              = "Lupus",
        category          = "vile_vial",
        description       = "Fever climbing fast. Lab Kit, Ultrasound (auto-adds 1 incision + howl), 2 Scalpels, Fix It. 2 shattered bones. Lupus howl adds incisions randomly each turn (~10%).",
        initialTemp       = 100.1,
        tempRising        = true,
        initialPulse      = "STRONG",
        initialBleeding   = "SLIGHT",
        initialVisibility = "HARD",
        initialSiteClean  = "DIRTY",
        brokenBones       = 0,
        shatteredBones    = 2,
        needsLabKit       = true,
        needsUltrasound   = true,
        needsFixIt        = true,
        requiredScalpels  = 2,  -- ultrasound auto-adds 1 incision; Fix It at total incisions=3
        heartStopChance   = 0,
        specialEvent      = "howl",
        headline          = "Patient suffers from Lupus and has begun howling uncontrollably and growing fur and fangs.",
        scalpelHeadline   = "You've exposed the heart of the infection.",
        scalpelContextMsg = "You've made a neat incision.",
        fixItHeadline     = "You've drawn the corrupted blood out of the patient and severed their connection to Lupus.",
    },

    BRAINWORMS = {
        name              = "Brainworms",
        category          = "vile_vial",
        description       = "RAPID bleeding, fever climbing fast. Lab Kit, Ultrasound (1 shattered bone). Fix It first at depth 3. Worms escape 10%/turn → move to random depth 1-5. Win: Fix It + incisions=0.",
        initialTemp       = 100.58,
        tempRising        = true,
        initialPulse      = "STEADY",
        initialBleeding   = "RAPID",
        ...
        needsUltrasound   = true,
        needsFixIt        = true,
        requiredScalpels  = 3,   -- Fix It first appears at incisions=3 (wormsInitialDepth)
        heartStopChance   = 0,
        specialEvent      = "brainworms",
        wormsInitialDepth = 3,   -- Fix It first ready at this incision depth
        wormsEscapeChance = 0.10, -- chance per turn worms move to new depth
        wormsMinDepth     = 1,   -- random range after escape
        wormsMaxDepth     = 5,
        headline          = "Patient suffers from Brainworms.",
        scalpelHeadline   = "You've made a neat incision.",
        scalpelContextMsg = "You've made a neat incision.",
        fixItHeadline     = "You've shut down the worm party in the patient's brain and cleared away their trash.",
    },

    MOLDY_GUTS = {
        name              = "Moldy Guts",
        category          = "vile_vial",
        description       = "Weak pulse, high fever, HARD visibility, starts Unsanitary. Lab Kit, Ultrasound (1 shattered), 2 Scalpels, Fix It. Guts burst 10%/turn → IMPOSSIBLE + sponge only. Temp rise 10%/turn.",
        initialTemp       = 104.6,
        tempRising        = true,
        initialPulse      = "WEAK",
        initialBleeding   = "NONE",
        ...
        gutsBurstChance   = 0.10,  -- visibility → IMPOSSIBLE, sponge-only turn
        gutsTempRiseChance = 0.10, -- temp starts slowly rising each trigger
        headline          = "Patient suffers from Moldy Guts.",
        scalpelHeadline   = "You've opened the abdomen.",
        scalpelContextMsg = "You've made a neat incision.",
        fixItHeadline     = "You've scraped the festering mold out of the patient's guts and restored their digestive system.",
    },

    ECTO_BONES = {
        name              = "Ecto-Bones",
        category          = "vile_vial",
        description       = "Normal temp, HARD visibility, Not sanitized. Ultrasound reveals 6 broken + 2 shattered bones, Fix It ready immediately (no scalpels needed). No special event.",
        initialTemp       = 98.6,
        tempRising        = false,
        initialPulse      = "STEADY",
        initialBleeding   = "NONE",
        ...
        needsUltrasound   = true,
        needsFixIt        = true,
        requiredScalpels  = 0,  -- Fix It ready immediately after Ultrasound
        heartStopChance   = 0,
        headline          = "You've exposed the ribs.",
        fixItHeadline     = "You pinned down all the patient's major bones and dyed them back to their normal color.",
    },

    FATTY_LIVER = {
        name              = "Fatty Liver",
        category          = "vile_vial",
        description       = "Strong pulse, fever climbing fast, HARD visibility, starts Unsanitary. Lab Kit, Ultrasound, 3 Scalpels, Fix It. Guaranteed heart stop at incisions=2, then 15% per turn.",
        initialTemp       = 101.6,
        tempRising        = true,
        initialPulse      = "STRONG",
        initialBleeding   = "NONE",
        ...
        needsFixIt        = true,
        requiredScalpels  = 3,
        heartStopChance   = 0.15,  -- per-turn after the guaranteed stop at depth 2
        specialEvent      = "fatty_liver",
        fattyHeartStopDepth = 2,   -- heart ALWAYS stops when incisions reach this depth
        headline          = "Patient's poor diet has led to a high degree of fat build-up in their liver.",
        scalpelHeadline   = "You've made a neat incision.",
        scalpelContextMsg = "You've made a neat incision.",
        fixItHeadline     = "You've drained the fatty deposits from the patient's liver and got their heart beating steadily again.",
    },
}
...
-- Maps MaladySystem malady type → surgery DIAG key
-- Used by operating_table to force the matching diagnosis for infected patients
M.MALADY_TO_DIAG_KEY = {
    CHICKEN_FEET         = "CHICKEN_FEET",
    TORN_PUNCHING_MUSCLE = "TORN_PUNCHING_MUSCLE",
    GRUMBLETEETH         = "GRUMBLETEETH",
    GEMS_CUTS            = "GEM_CUTS",            -- malady: GEMS_CUTS, diag: GEM_CUTS
    BROKEN_HEARTS        = "BROKEN_HEART_MALADY", -- malady: BROKEN_HEARTS, diag: BROKEN_HEART_MALADY
    ...
    -- AUTOMATION_CURSE: tidak ada surgery diagnosis → nil → fall back ke random standard
}
