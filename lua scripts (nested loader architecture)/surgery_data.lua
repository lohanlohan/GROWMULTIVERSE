...
M.DIAG = {
    ...
    CHAOS_INFECTION = {
        ...
        heartStopChance  = 0,
        specialEvent      = "chaos",
        headline          = "Patient has a chaos infection. Anything can happen.",
    },
    ...
    LUPUS = {
        ...
        heartStopChance  = 0,
        specialEvent      = "howl",
        headline          = "Patient is infected with lupus.",
        scalpelHeadline   = "The infection is deep in the tissue.",
        scalpelContextMsg = "The infection is deep in the tissue.",
        fixItHeadline     = "You eradicated the lupus infection!",
    },
    ...
    BRAINWORMS = {
        ...
        headline          = "Patient has worms in their brain.",
        scalpelHeadline   = "You've opened the skull — worms are visible!",
        scalpelContextMsg = "You've opened the skull — worms are visible!",
        fixItHeadline     = "You removed the brainworms!",
    },
    ...
    MOLDY_GUTS = {
        ...
        headline          = "Patient's guts are infested with mold.",
        scalpelHeadline   = "You've found the moldy intestines.",
        scalpelContextMsg = "You've found the moldy intestines.",
        fixItHeadline     = "You cleaned out the moldy guts!",
    },
    ...
    ECTO_BONES = {
        ...
        headline          = "Patient has ghost bones throughout their body.",
        scalpelHeadline   = "You've found the ecto-bone fragments.",
        scalpelContextMsg = "You've found the ecto-bone fragments.",
        fixItHeadline     = "You removed the ecto-bone fragments!",
    },
    ...
    FATTY_LIVER = {
        ...
        headline          = "Patient has a severely fatty liver.",
        scalpelHeadline   = "You've found the fat-encased liver.",
        scalpelContextMsg = "You've found the fat-encased liver.",
        fixItHeadline     = "You drained the fatty deposits!",
    },
}
